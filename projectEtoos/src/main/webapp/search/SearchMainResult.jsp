...
<body>
		...
		<div class="container center">
			...
			<div class="tap">
				<ul>
					...
					<li class="selected-tab"><span><a href="./searchMain.do?search_word=${keyword }">전체</a></span></li>
					<li><span><a href="./searchMain.do?bbs=teacher&search_word=${keyword }">선생님</a></span></li>
					<li><span><a href="./searchMain.do?bbs=course&search_word=${keyword }">강좌</a></span></li>
			<li><span><a href="./searchMain.do?bbs=notice&search_word=${keyword }">공지사항</a></span></li>
	...
	<div class="gonjiList" id="gonjiList">
			...
			<div class="listTitle">
					...
					<p id="title_g">공지사항<button type="button" class= "gumsaekdeo">더보기</button>
